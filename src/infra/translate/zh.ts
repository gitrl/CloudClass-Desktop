export const zh = {
  ...
  fcr_raisehand_label_choose_interaction_mode: '请至少选择一种连线方式',
  ...
  fcr_raisehand_button_request_interaction: '申请连线',
  fcr_raisehand_button_disconnect_interaction: '断开连线',
  fcr_raisehand_label_waiting_teacher_approve: '正在等待老师通过你的连线申请',
  fcr_raisehand_label_waiting_interaction: '等待连线...',
  fcr_raisehand_label_Interacting: '正在连线',
  fcr_raisehand_label_Interacting_now: '现在可以开始连线了',
  fcr_raisehand_tips_interaction_approved: '已通过连线申请',
  fcr_raisehand_tips_interaction_denied: '连线申请被拒绝',
  fcr_raisehand_tips_waiting_interaction_close_all: '请至少保留一种连线方式',
  fcr_raisehand_tips_interaction_disconnected: '连线已断开',
